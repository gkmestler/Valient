...
export default function Leadership() {
  ...
  const teamMembers = [
    ...
    { name: 'Brendan Hardiman', role: 'Head of Field Services', image: '/images/V-Brendan Hardiman.png', bio: 'Brendan is the founder of Tuition Landscaping, a business he built from the ground up to $150K+ in revenue. He brings hands-on experience in field operations, client management, and scaling service businesses.', imageStyle: { transform: 'scale(1.3) translateY(14%)' }, brightness: 1.3 },
