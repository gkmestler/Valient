...
export default function Leadership() {
  ...
  const teamMembers = [
    ...
    { name: 'Dean Farber', role: 'Managing Partner and CFO', image: '/images/V-Dean Farber.png', bio: 'Dean is the founder of Duff Goods, an independently operated e-commerce business with $1M+ in revenue, and has experience across product sourcing, online sales, and managing the full lifecycle of a small business from end to end.', imageStyle: { transform: 'scale(1.0) translateY(3%)' }, linkedin: '', brightness: 1.2 },
