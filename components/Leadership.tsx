...
export default function Leadership() {
  ...
  const teamMembers = [
    ...
    { name: 'Dean Farber', role: 'Managing Partner', image: '/images/V-Dean Farber.png', bio: '', imageStyle: { transform: 'scale(1.0) translateY(3%)' }, linkedin: '', brightness: 1.2 },
