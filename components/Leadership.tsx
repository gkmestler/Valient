...
export default function Leadership() {
  ...
  const teamMembers = [
    ...
    { name: 'Brendan Hardiman', role: 'Head of Field Services', image: '/images/V-Brendan Hardiman.png', bio: 'Brendan is the founder of Tuition Landscaping, a landscaping business built from the ground up, with hands-on experience in field operations, client management, and scaling service-based businesses.', imageStyle: { transform: 'scale(1.3) translateY(14%)' }, brightness: 1.3 },
